    ...
    <div className="min-h-screen pt-32 pb-20 px-6 flex items-center justify-center">
      <div className="max-w-4xl w-full">
        ...
        <motion.h1
          ...
          className="text-5xl font-bold text-center mb-12 bg-gradient-to-r from-[#00D9FF] to-[#B026FF] bg-clip-text text-transparent"
        >
          Socials
        </motion.h1>
        ...
        >
          <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-[#00D9FF]/30 shadow-[0_0_20px_rgba(0,217,255,0.5)]">
            <img
              src={socialsData.photo}
              alt="Profile"
        ...
        <motion.p
          ...
          className="text-2xl text-center text-white/90 mb-12 font-medium"
        >
          {socialsData.message}
        </motion.p>
        ...
        >
          {socialsData.socials.map((social, index) => (
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center gap-4 bg-white hover:bg-[#00D9FF] text-[#0A0A0F] px-6 py-4 rounded-xl transition-all duration-300 group shadow-md hover:shadow-[0_0_20px_rgba(0,217,255,0.5)]"
            >
